                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex items-start space-x-4 p-4 rounded-lg hover:bg-gray-50 transition duration-300">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 mt-1">
                                Saat ini berjalan dalam mode build (statis). Gunakan <code class="bg-gray-200 px-1 py-0.5 rounded text-sm text-red-500">npm run build</code> jika mengubah tampilan.
                            </p>
                        </div>
                    </div>
