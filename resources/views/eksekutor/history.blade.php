            ...
            <form method="GET" action="{{ route('eksekutor.history') }}" id="filterForm">
                ...
                <div class="flex flex-col gap-3 sm:flex-row">
                    ...
                    <x-filter-popup
                        ...
                        reset-url="{{ route('eksekutor.history') }}"
                        :badge="$activeFilters">

                        {{-- Jenis Layanan --}}
                        <div class="fp-field">
                            <label for="fp-layanan-hist">Jenis Layanan</label>
                            <select name="layanan" id="fp-layanan-hist" form="filterForm">
                        ...
                        <div class="fp-field">
                            ...
                            <div class="fp-date-row">
                                <div class="fp-date-col">
                                    <label for="fp-dari-hist">Dari</label>
                                    <input type="date" name="tanggal_dari" id="fp-dari-hist" form="filterForm"
                                           value="{{ request('tanggal_dari') }}">
                                </div>
                                <div class="fp-date-col">
                                    <label for="fp-sampai-hist">Sampai</label>
                                    <input type="date" name="tanggal_sampai" id="fp-sampai-hist" form="filterForm"
