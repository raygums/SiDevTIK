        ...
        <div class="p-6">
            <form method="GET" action="{{ route('verifikator.index') }}" id="filterForm">
                ...
                <div class="flex flex-col gap-3 sm:flex-row">
                    ...
                    <x-filter-popup
                        form-id="filterForm"
                        modal-id="filterModalVerifikator"
                        title="Filter Pengajuan"
                        reset-url="{{ route('verifikator.index') }}"
                        :badge="$activeFilters">

                        {{-- Jenis Layanan --}}
                        <div class="fp-field">
                            <label for="fp-layanan-v">Jenis Layanan</label>
                            <select name="layanan" id="fp-layanan-v" form="filterForm">
                        ...
                        <div class="fp-field">
                            ...
                            <div class="fp-date-row">
                                <div class="fp-date-col">
                                    <label for="fp-dari-v">Dari</label>
                                    <input type="date" name="tanggal_dari" id="fp-dari-v" form="filterForm"
                                           value="{{ request('tanggal_dari') }}">
                                </div>
                                <div class="fp-date-col">
                                    <label for="fp-sampai-v">Sampai</label>
                                    <input type="date" name="tanggal_sampai" id="fp-sampai-v" form="filterForm"
